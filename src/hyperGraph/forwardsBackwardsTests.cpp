...
void FowrardsBackwards::FowrardsBackwardsTests() {
    failWithMessage(__FILE__,__LINE__,"assert statement");
}

void FowrardsBackwards::getAValForTests() {
    failWithMessage(__FILE__,__LINE__,"assert statement");
}

void FowrardsBackwards::getBValForTests() {
    failWithMessage(__FILE__,__LINE__,"assert statement");
}

void FowrardsBackwards::getCValForTests() {
    failWithMessage(__FILE__,__LINE__,"assert statement");
}

void FowrardsBackwards::getProbOfDAHTests() {
    failWithMessage(__FILE__,__LINE__,"assert statement");
}
