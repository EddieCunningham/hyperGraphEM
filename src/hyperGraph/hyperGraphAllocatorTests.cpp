...
void HyperGraphAllocator::HyperGraphAllocatorTests() {
    failWithMessage(__FILE__,__LINE__,"assert statement");
}

void HyperGraphAllocator::allocateDataTests() {
    failWithMessage(__FILE__,__LINE__,"assert statement");
}

void HyperGraphAllocator::allocateNodeTests() {
    failWithMessage(__FILE__,__LINE__,"assert statement");
}

void HyperGraphAllocator::allocateFamilyTests() {
    failWithMessage(__FILE__,__LINE__,"assert statement");
}

void HyperGraphAllocator::allocateDAHTests() {
    failWithMessage(__FILE__,__LINE__,"assert statement");
}

void HyperGraphAllocator::deallocateDataTests() {
    failWithMessage(__FILE__,__LINE__,"assert statement");
}

void HyperGraphAllocator::deallocateNodesTests() {
    failWithMessage(__FILE__,__LINE__,"assert statement");
}

void HyperGraphAllocator::deallocateFamiliesTests() {
    failWithMessage(__FILE__,__LINE__,"assert statement");
}

void HyperGraphAllocator::deallocateDAHTests() {
    failWithMessage(__FILE__,__LINE__,"assert statement");
}
